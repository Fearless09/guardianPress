        ...
        <>
            <nav className="navbar navbar-expand-lg z-2 bg-info position-fixed w-100 top-0">
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse flex-grow-0" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" title='GitHub' aria-current="page" href="#">
                            ...
                            {/* Twitter */}
                            <li className="nav-item">
                                <a className="nav-link" title='Twitter' aria-current="page" href="#">
                            ...
                            {/* LinkedIn */}
                            <li className="nav-item">
                                <a className="nav-link" title='LinkedIN' aria-current="page" href="#">
                    ...
                    {/* Nav Brand */}
                    <Link to={'/'} className="navbar-brand text-white fs-4 fw-bold text-uppercase" onClick={GotoHome}>Guardian Press</Link>
